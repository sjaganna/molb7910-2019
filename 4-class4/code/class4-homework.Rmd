...
1. M-A plot for the three time points. (M or log ratio here is`logFC`, and A or mean average here is `logCPM`)  

2. Volcano plot for the three time points. (Volcano plot is `logFC` vs. -log10 of `FDR`)  
