...
# read in dux data
dux_data <- read_csv(file ="3-class3/data/input/data_transcript.csv")
...
save_plot(filename = "3-class3/images/target_gene_plot.png", plot = p_target_gene, base_width = 6, base_height = 4)

save_plot(filename = "3-class3/images/gene_target_plot.png", plot = p_gene_target, base_width = 4, base_height = 3)


save_plot(filename = "3-class3/images/final_plot.png", plot = p_final, base_width = 8, base_height = 8)
```
