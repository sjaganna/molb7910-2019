...
```{r, echo = FALSE}
knitr::include_graphics("/Users/sjaganna/Desktop/CU-onedrive/OneDrive - The University of Colorado Denver/08-teaching/molb7910/1-class1/images/readr2.png", dpi = 200)
```

Using some of the following arguments makes it easier to control how we want to input the data. 
```{r, echo = FALSE}
knitr::include_graphics("/Users/sjaganna/Desktop/CU-onedrive/OneDrive - The University of Colorado Denver/08-teaching/molb7910/1-class1/images/readr3.png", dpi = 200)
```
...
```{r, echo = FALSE}
knitr::include_graphics("/Users/sjaganna/Desktop/CU-onedrive/OneDrive - The University of Colorado Denver/08-teaching/molb7910/1-class1/images/tidydata.png", dpi = 200)
```
...
```{r, echo = FALSE}
knitr::include_graphics("/Users/sjaganna/Desktop/CU-onedrive/OneDrive - The University of Colorado Denver/08-teaching/molb7910/1-class1/images/wrangling1.png", dpi = 200)
```

```{r, echo = FALSE}
knitr::include_graphics("/Users/sjaganna/Desktop/CU-onedrive/OneDrive - The University of Colorado Denver/08-teaching/molb7910/1-class1/images/wrangling2.png", dpi = 140)
```
...
```{r, echo = FALSE}
knitr::include_graphics("/Users/sjaganna/Desktop/CU-onedrive/OneDrive - The University of Colorado Denver/08-teaching/molb7910/1-class1/images/regex.png", dpi = 120)
```
