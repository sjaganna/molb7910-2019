...
```{r, echo = FALSE}
knitr::include_graphics("/Users/sjaganna/Desktop/CU-onedrive/OneDrive - The University of Colorado Denver/08-teaching/molb7910/1-class1/images/readr1.png", dpi = 260)
```
...
```{r echo = FALSE}
knitr::include_graphics(here("1-class1", "images", "tidyr-verbs.png"), dpi = 300)
```

```{r echo = FALSE}
knitr::include_graphics(here("1-class1", "images", "reshape-data.png"), dpi = 200)
```
...
```{r echo = FALSE}
knitr::include_graphics(here("1-class1", "images", "join.png"), dpi = 200)
```
